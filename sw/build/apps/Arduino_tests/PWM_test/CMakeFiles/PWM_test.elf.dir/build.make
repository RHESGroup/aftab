...
apps/Arduino_tests/PWM_test/CMakeFiles/PWM_test.elf.dir/PWM_test.cpp.o: ../apps/Arduino_tests/PWM_test/PWM_test.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object apps/Arduino_tests/PWM_test/CMakeFiles/PWM_test.elf.dir/PWM_test.cpp.o"
	cd /media/sf_Shared/pulpino/sw/build/apps/Arduino_tests/PWM_test && /opt/riscv/bin/riscv32-unknown-elf-gcc  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/PWM_test.elf.dir/PWM_test.cpp.o -c /media/sf_Shared/pulpino/sw/apps/Arduino_tests/PWM_test/PWM_test.cpp
...
apps/Arduino_tests/PWM_test/CMakeFiles/PWM_test.elf.dir/PWM_test.cpp.i: cmake_force
	...
	cd /media/sf_Shared/pulpino/sw/build/apps/Arduino_tests/PWM_test && /opt/riscv/bin/riscv32-unknown-elf-gcc $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /media/sf_Shared/pulpino/sw/apps/Arduino_tests/PWM_test/PWM_test.cpp > CMakeFiles/PWM_test.elf.dir/PWM_test.cpp.i
...
apps/Arduino_tests/PWM_test/CMakeFiles/PWM_test.elf.dir/PWM_test.cpp.s: cmake_force
	...
	cd /media/sf_Shared/pulpino/sw/build/apps/Arduino_tests/PWM_test && /opt/riscv/bin/riscv32-unknown-elf-gcc $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /media/sf_Shared/pulpino/sw/apps/Arduino_tests/PWM_test/PWM_test.cpp -o CMakeFiles/PWM_test.elf.dir/PWM_test.cpp.s
...
apps/Arduino_tests/PWM_test/PWM_test.elf: apps/Arduino_tests/PWM_test/CMakeFiles/PWM_test.elf.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable PWM_test.elf"
	cd /media/sf_Shared/pulpino/sw/build/apps/Arduino_tests/PWM_test && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/PWM_test.elf.dir/link.txt --verbose=$(VERBOSE)
...
apps/Arduino_tests/PWM_test/CMakeFiles/PWM_test.elf.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/Arduino_tests/PWM_test && $(CMAKE_COMMAND) -P CMakeFiles/PWM_test.elf.dir/cmake_clean.cmake
