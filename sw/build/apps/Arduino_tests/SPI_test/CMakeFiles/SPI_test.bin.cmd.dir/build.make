...
apps/Arduino_tests/SPI_test/SPI_test.bin: apps/Arduino_tests/SPI_test/SPI_test.elf
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/media/sf_Shared/pulpino/sw/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating SPI_test.bin"
	cd /media/sf_Shared/pulpino/sw/build/apps/Arduino_tests/SPI_test && /opt/riscv/bin/riscv32-unknown-elf-objcopy -R .debug_frame -R .comment -R .stack -R .heapsram -R .heapscm -R .scmlock -O binary /media/sf_Shared/pulpino/sw/build/apps/Arduino_tests/SPI_test/SPI_test.elf SPI_test.bin
...
apps/Arduino_tests/SPI_test/CMakeFiles/SPI_test.bin.cmd.dir/clean:
	cd /media/sf_Shared/pulpino/sw/build/apps/Arduino_tests/SPI_test && $(CMAKE_COMMAND) -P CMakeFiles/SPI_test.bin.cmd.dir/cmake_clean.cmake
